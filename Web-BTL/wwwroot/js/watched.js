        ...
        success: function (response) {
            ...
            response.forEach((elm, index) => {
                var htmlElm = `
                    ...
                    <a class="t-movie" asp-controler="Movie" asp-action="Index" asp-route-movieId="${elm.MediaId}">
                        ...
                        <div class="t-movie-content">
                            ...
                            <div class="t-movie-info">
                                ...
                                <div>
                                    ...
                                    <span>${elm.MediaDuration}</span>
                                </div>
                                <div>
                                    <span>${elm.MediaQuality}</span>
                                </div>
                                <div>
                                    <span>${elm.MediaAgeRating}</span>
                                </div>
                            </div>
                        </div>
